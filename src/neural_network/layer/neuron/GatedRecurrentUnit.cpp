...
GatedRecurrentUnit::GatedRecurrentUnit(NeuronModel model, shared_ptr<NeuralNetworkOptimizer> optimizer)
    : numberOfInputs(model.numberOfInputs),
      resetGate({model.numberOfInputs, model.batchSize, model.numberOfWeights, activation::sigmoid}, optimizer),
      updateGate({model.numberOfInputs, model.batchSize, model.numberOfWeights, activation::sigmoid}, optimizer),
      outputGate({model.numberOfInputs, model.batchSize, model.numberOfWeights, activation::tanh}, optimizer)
{
}
