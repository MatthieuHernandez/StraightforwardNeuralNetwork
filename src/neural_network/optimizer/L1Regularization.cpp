...
void L1Regularization::applyAfterOutputForTraining([[maybe_unused]] std::vector<float>& outputs, bool)
{
}

void L1Regularization::applyAfterOutputForTesting([[maybe_unused]] std::vector<float>& outputs)
{
}
