...
{
    StraightforwardNeuralNetwork neuralNetwork({Input(3, 12, 12), MaxPooling(2), Convolution(3, 4), FullyConnected(60),
                                                MaxPooling(3), Convolution(1, 3), FullyConnected(20), Recurrence(10),
                                                FullyConnected(5)});
...
{
    StraightforwardNeuralNetwork neuralNetwork({Input(10), GruLayer(10), Recurrence(10)});
