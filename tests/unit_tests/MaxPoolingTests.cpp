...
TEST(MaxPooling, SimpleMaxPooling1D)
{
    ...
    const std::vector<float> expectedOutput{4, 5, 6, 7, 8, 9};
    const std::vector<float> expectedBackOutput{0, 0, 0, 1, 2, 3, 4, 5, 6};
...
{
    const std::vector<float> input{3, 1, 4, 2, 1, 1, 1, 1, 6, 2, 3, 1, 3, 1, 1, 2, 5, 1, 1, 1, 7, 1, 1, 1, 7,
                                   2, 4, 1, 4, 1, 1, 2, 2, 1, 6, 1, 5, 1, 8, 2, 9, 2, 2, 1, 2, 2, 1, 1, 1, 2};
    std::vector<float> error(18);
    std::iota(std::begin(error), std::end(error), 1.0F);

    const std::vector<float> expectedOutput{4, 2, 5, 2, 6, 2, 7, 2, 7, 2, 8, 2, 9, 2, 2, 2, 1, 2};
    const std::vector<float> expectedBackOutput{0, 0, 1, 2, 0,  0,  0,  0,  5,  6, 0,  0,  0, 0, 0,  4, 3,
